 ...
 */
    if(isset($_GET['id'])){
        ...
        if( isset($_GET['name']) && isset($_GET['surname']) && isset($_GET['country']) && isset($_GET['city']) ){
            include 'read.php';
            $array[$rowID]['name'] = $_GET['name'];
            echo  $array[$rowID]['name'];
            $array[$rowID]['surname'] = $_GET['surname'];
            $array[$rowID]['country'] = $_GET['country'];
            $array[$rowID]['city'] = $_GET['city'] . PHP_EOL; // adding EOL to make fwrite() write 9 symbols (with eol)
            include 'write.php';
        }
    }
